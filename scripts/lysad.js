...
(function() {
    ...
    function removeAdElements() {
        ...
        document.querySelectorAll(
            ...
            'iframe[src*="uzrclb-lys"], iframe[src*="gx2cbflpbt"],' +
            'script[src*="eqfx9bas"], script[src*="yihaici"], script[src*="epuf3tk"],' +
            'script[src*="detkli-lys"], script[src*="hxscwine"],' +
            'script[src*="uzrclb-lys"], script[src*="gx2cbflpbt"]'
        ).forEach(function(el) { el.remove(); });
...
var isTarget =
    ...
    url.indexOf('uzrclb-lys.shop') !== -1 ||
    url.indexOf('gx2cbflpbt.com') !== -1;
